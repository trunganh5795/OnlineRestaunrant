                            ...
                            <div className="col-md-12">
                                ...
                                <div className="container">
                                    ...
                                    >
                                        ...
                                        <div className={this.props.message === "update successfully" ? "alert  alert-success" : "alert  alert-danger"} style={{ display: `${this.props.message ? 'block' : 'none'}` }}>{this.props.message}</div>
